        ...
        <div className="px-4 space-y-5">
          <div className="flex flex-col gap-5">
            ...
            <div className="flex md:flex-row flex-col gap-2 md:gap-8 border-b border-gray-200 pb-4 ">
              ...
              <div className=" flex items-center gap-2 w-full md:w-lg rounded-lg py-2.5 px-3.5 border border-gray-300 shadow ">
          ...
          <div className="flex  gap-8">
            ...
            <div className="w-lg flex gap-5">
              ...
              <div
                ...
                onDrop={handleOnDrop}
                className="flex flex-col items-center justify-center py-4 px-6 gap-3 shadow border border-gray-200 w-full rounded-lg"
              >
            ...
            <div className="md:w-lg w-full flex flex-col gap-4">
              <div className="w-full">
                <input
                  ...
                  placeholder="Abuja"
                  className="w-full text-gray-900 rounded-lg py-2.5 px-3.5 border border-gray-300 shadow outline-none "
                />
              </div>
          ...
          <div className="flex w-full justify-end">
            <div className="flex items-center gap-3 mt-4">
              ...
              <button type="submit" className=" text-base font-semibold text-white flex items-center justify-center rounded-lg py-3.5 px-7 bg-[#5C2E1B]">
                Save
              </button>
            </div>
          </div>

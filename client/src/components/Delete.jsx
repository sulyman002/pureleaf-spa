    ...
    <div className="fixed flex items-center justify-center z-99 inset-0 bg-[#34405499]/60 backdrop-blur-[2px]">
      <div className="bg-white w-[400px] rounded-xl flex flex-col gap-2 px-6  py-8">
        ...
        <div className="flex items-center justify-center gap-5 flex-col ">
            ...
            <div className="flex items-center justify-center flex-col gap-2 ">
                ...
                <div className="text-center flex flex-col gap-4 text-sm font-400 text-gray-500">
                    <p>Are you sure you want to delete the <b className="text-gray-900">‘Breakfast’</b> menu?</p>
        ...
        <div className="flex items-center w-full gap-3 mt-4">
          <button className="w-full text-base font-semibold text-[#404652] flex items-center justify-center rounded-lg py-2.5 px-7 border border-[#E2E8F0] bg-gray-50 ">
            Cancel
          </button>
            <button className="w-full text-base font-semibold text-white flex items-center justify-center rounded-lg py-2.5 px-7 bg-red-700">
            Delete
          </button>
        </div>
      </div>

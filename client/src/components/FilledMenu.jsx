...
import { ChevronDown, CloudUpload, Eye, SquarePen, Trash2, Utensils } from "lucide-react";
  ...
  return (
    <div className="flex flex-col gap-6 py-5 ">
      ...
      <div className="px-4 md:px-8 grid md:grid-cols-2 lg:grid-cols-5 gap-y-8 gap-x-6 ">
        <div className=" p-4.5  flex flex-col gap-3.5 rounded-xl bg-[#FBFAF9] border border-gray-200 shadow-md hover:shadow-2xl transition-all duration-300 ">
          <div className="flex flex-col gap-3 w-full ">
            <div className="flex items-center justify-between ">
              <div className="h-6 w-6 rounded-md border border-[#5C2E1B] p-1 flex items-center justify-center "><Utensils size={16} /></div>
              <div className="">
            ...
            <div className="flex flex-col gap-2">
                <p className="font-600 font-semibold text-sm text-gray-900 ">Movie Night</p>
